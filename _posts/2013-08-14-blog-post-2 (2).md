...
Moving beyond forecasts to real-time data. This project uses the 'WeatherToday' API to create a live dashboard featuring a heatmap bar chart of Thailand's hottest stations and a bubble map tracking rainfall intensity across the country.
