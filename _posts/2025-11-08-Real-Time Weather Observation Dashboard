...
date: 2025-12-08
permalink: /posts/2025/12/Real-Time-Weather-Observation-Dashboard/
tags:
...
def process_weather_visuals_upgrade():
    ...
    if not rows:
        print("❌ No valid numerical data found for plotting")
        return

    df = pd.DataFrame(rows)
    print(f"✅ Data preparation successful: {len(df)} stations")

    # ========================================================
    # 📊 GRAPH 1: Heatmap Bar Chart
    # ========================================================
    ...
    for bar in bars:
        ...
        plt.text(bar.get_x() + bar.get_width()/2., height + 0.1,
                 f'{height:.1f}°C', ha='center', va='bottom', fontsize=9, fontweight='bold')
